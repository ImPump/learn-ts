...
console.log('多类型参数：', stringNumberPair, booleanStringPair)
...
console.log('多类型参数类：', userAge.toString(), productPrice.toString())
...
console.log('长度约束：', getLength('Hello'), getLength([1, 2, 3]), getLength({ length: 5 }))
